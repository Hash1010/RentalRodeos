define("UsrPage_sqoo2uq", /**SCHEMA_DEPS*/[]/**SCHEMA_DEPS*/, function/**SCHEMA_ARGS*/()/**SCHEMA_ARGS*/ {
	return {
		viewConfigDiff: /**SCHEMA_VIEW_CONFIG_DIFF*/[
			...
			},
			{
				...
				"values": {
					...
					"type": "crt.ComboBox",
					"label": "$Resources.Strings.UsrSelectedPropertiesDS_UsrProperty_3aldiim",
					"labelPosition": "above",
					"control": "$UsrSelectedPropertiesDS_UsrProperty_3aldiim",
					"listActions": [],
			...
			{
				"operation": "insert",
				"name": "addRecord_i4ul49j",
				"values": {
					"code": "addRecord",
					"type": "crt.ComboboxSearchTextAction",
					"icon": "combobox-add-new",
					"caption": "#ResourceString(addRecord_i4ul49j_caption)#",
					"clicked": {
		...
		modelConfigDiff: /**SCHEMA_MODEL_CONFIG_DIFF*/[
			{
				...
				"values": {
					...
					"primaryDataSourceName": "UsrSelectedPropertiesDS"
				}
			}
