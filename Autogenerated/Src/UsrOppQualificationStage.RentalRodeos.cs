namespace Terrasoft.Core.Process
{
	...
	#region Class: UsrOppQualificationStageMethodsWrapper

	/// <exclude/>
	public class UsrOppQualificationStageMethodsWrapper : ProcessModel
	{

		public UsrOppQualificationStageMethodsWrapper(Process process)
			: base(process) {
